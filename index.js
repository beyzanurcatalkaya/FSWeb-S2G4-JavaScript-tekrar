...
ucetambolunenler = [];
sayilar.forEach(n => {
  if (n % 1 === 0 && n % 3 === 0) ucetambolunenler.push(n);
});
console.log(ucetambolunenler);

// 3c çözümü:

ucebolunenlerintoplami = ucetambolunenler.reduce((toplam,n) => toplam + n, 0);
console.log("3'e tam bölünenlerin toplamı:", ucebolunenlerintoplami);

// 3d çözümü

besyuzdenkucuksayilar = sayilar.filter(n => n < 500);
console.log("500'den küçükler:", besyuzdenkucuksayilar);
